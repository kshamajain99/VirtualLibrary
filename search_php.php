...
<link href="search_css.css" rel="stylesheet" type="text/css" />
...
$id = $_SESSION['uid'];
$squery=$_POST['q'];
$query = "SELECT * FROM books where  bname = '$squery'";  //You don't need a ; like you do in SQL
